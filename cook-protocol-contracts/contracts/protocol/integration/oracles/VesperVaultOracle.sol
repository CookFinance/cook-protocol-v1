...
/**
 * @title VesperVaultOracle
 * @author Cook Finance, Ember Fund
 *
 * Oracle built to retrieve the Vesper vault price
 */
contract VesperVaultOracle is IOracle
{
    ...
    /* ============ State Variables ============ */
    IVToken public immutable vault;
    ...
    /*
     * @param  _vault               The address of Vesper Vault Token
