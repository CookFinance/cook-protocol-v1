...
library AaveV2 {
    ...
    /**
     * Get deposit calldata from CKToken
     *
    ...
    /**
     * Invoke deposit on LendingPool from CKToken
     * 
     * Deposits an `_amountNotional` of underlying asset into the reserve, receiving in return overlying aTokens.
     * - E.g. CKToken deposits 100 USDC and gets in return 100 aUSDC
        ...
        external
    {
        ...
        _ckToken.invoke(address(_lendingPool), 0, depositCalldata);
    }
    
    /**
     * Get withdraw calldata from CKToken
     * 
    ...
    /**
     * Invoke withdraw on LendingPool from CKToken
     * 
     * Withdraws an `_amountNotional` of underlying asset from the reserve, burning the equivalent aTokens owned
     * - E.g. CKToken has 100 aUSDC, and receives 100 USDC, burning the 100 aUSDC
     *     
     * @param _ckToken          Address of the CKToken
     * @param _lendingPool      Address of the LendingPool contract
     * @param _asset            The address of the underlying asset to withdraw
        ...
        returns (uint256)
    {
        ...
        return abi.decode(_ckToken.invoke(address(_lendingPool), 0, withdrawCalldata), (uint256));
    }
    
    /**
     * Get borrow calldata from CKToken
     *
    ...
    /**
     * Invoke borrow on LendingPool from CKToken
     *
     * Allows CKToken to borrow a specific `_amountNotional` of the reserve underlying `_asset`, provided that 
     * the CKToken already deposited enough collateral, or it was given enough allowance by a credit delegator
     * on the corresponding debt token (StableDebtToken or VariableDebtToken)
     * @param _ckToken              Address of the CKToken
     * @param _lendingPool          Address of the LendingPool contract
     * @param _asset                The address of the underlying asset to borrow
        ...
        external
    {
        ...
        _ckToken.invoke(address(_lendingPool), 0, borrowCalldata);
    }

    /**
     * Get repay calldata from CKToken
     *
    ...
    /**
     * Invoke repay on LendingPool from CKToken
     *
     * Repays a borrowed `_amountNotional` on a specific `_asset` reserve, burning the equivalent debt tokens owned
     * - E.g. CKToken repays 100 USDC, burning 100 variable/stable debt tokens
     * @param _ckToken              Address of the CKToken
     * @param _lendingPool          Address of the LendingPool contract
     * @param _asset                The address of the borrowed underlying asset previously borrowed
     * @param _amountNotional       The amount to repay
        ...
        returns (uint256)
    {
        ...
        return abi.decode(_ckToken.invoke(address(_lendingPool), 0, repayCalldata), (uint256));
    }

    /**
     * Get setUserUseReserveAsCollateral calldata from CKToken
     * 
    ...
    /**
     * Invoke an asset to be used as collateral on Aave from CKToken
     *
     * Allows CKToken to enable/disable a specific deposited asset as collateral
     * @param _ckToken              Address of the CKToken
     * @param _lendingPool          Address of the LendingPool contract
     * @param _asset                The address of the underlying asset deposited
     * @param _useAsCollateral      true` if the user wants to use the deposit as collateral, `false` otherwise
        ...
        external
    {
        ...
        _ckToken.invoke(address(_lendingPool), 0, callData);
    }
    
    /**
     * Get swapBorrowRate calldata from CKToken
     *
    ...
    /**
     * Invoke to swap borrow rate of CKToken
     * 
     * Allows CKToken to toggle it's debt between stable and variable mode
     * @param _ckToken          Address of the CKToken
     * @param _lendingPool      Address of the LendingPool contract
     * @param _asset            The address of the underlying asset borrowed
     * @param _rateMode         The rate mode that the user wants to swap to
