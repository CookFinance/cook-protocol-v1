...
contract WrapModuleV2 is ModuleBase, ReentrancyGuard {
        ...
        returns (uint256, uint256)
    {
        ...
        if (_usesEther) {
            ...
            _ckToken.invokeApprove(_underlyingToken, wrapAdapter.getSpenderAddress(_underlyingToken, _wrappedToken), notionalUnderlying);
        }
        ...
        returns (uint256, uint256)
    {
        ...
        _ckToken.invokeApprove(_wrappedToken, wrapAdapter.getSpenderAddress(_underlyingToken, _wrappedToken), notionalWrappedToken);
