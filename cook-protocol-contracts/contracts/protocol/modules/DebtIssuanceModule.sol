...
contract DebtIssuanceModule is ModuleBase, ReentrancyGuard {
    ...
    /**
     * Returns components from the CKToken, unwinds any external module component positions and burns 
     * the CKToken. If the token has a debt position all debt will be paid down first then equity positions
