...
import { ManagerIssuanceHookMock, NAVIssuanceHookMock, NavIssuanceModule, CKToken } from "@utils/contracts";
...
describe("NavIssuanceModule", () => {
  ...
  describe("#initialize", async () => {
    ...
    it("should set the correct NAV issuance settings", async () => {
      ...
      const navIssuanceSettings: any = await navIssuanceModule.navIssuanceSettings(subjectCKToken);
      const retrievedReserveAssets = await navIssuanceModule.getReserveAssets(subjectCKToken);
      const managerIssueFee = await navIssuanceModule.getManagerFee(subjectCKToken, ZERO);
      const managerRedeemFee = await navIssuanceModule.getManagerFee(subjectCKToken, ONE);
    ...
    it("should enable the Module on the CKToken", async () => {
      ...
      const isModuleEnabled = await ckToken.isInitializedModule(navIssuanceModule.address);
    ...
    it("should properly set reserve assets mapping", async () => {
      ...
      const isUsdcReserveAsset = await navIssuanceModule.isReserveAsset(subjectCKToken, setup.usdc.address);
      const isWethReserveAsset = await navIssuanceModule.isReserveAsset(subjectCKToken, setup.weth.address);
    ...
    describe("when CKToken is not in pending state", async () => {
      beforeEach(async () => {
        ...
        const navIssuanceModuleNotPendingCKToken = await setup.createCKToken(
          [setup.weth.address],
          [ether(1)],
          [newModule]
        );

        subjectCKToken = navIssuanceModuleNotPendingCKToken.address;
      });
  ...
  describe("#removeModule", async () => {
    ...
    it("should delete reserve assets state", async () => {
      ...
      const isUsdcReserveAsset = await navIssuanceModule.isReserveAsset(ckToken.address, setup.usdc.address);
      const isWethReserveAsset = await navIssuanceModule.isReserveAsset(ckToken.address, setup.weth.address);
  ...
  describe("#getReserveAssets", async () => {
    ...
    async function subject(): Promise<any> {
      return navIssuanceModule.getReserveAssets(subjectCKToken);
    }
  ...
  describe("#getIssuePremium", async () => {
    ...
    async function subject(): Promise<any> {
      return navIssuanceModule.getIssuePremium(subjectCKToken, subjectReserveAsset, subjectReserveQuantity);
    }
  ...
  describe("#getRedeemPremium", async () => {
    ...
    async function subject(): Promise<any> {
      return navIssuanceModule.getRedeemPremium(subjectCKToken, subjectReserveAsset, subjectCKTokenQuantity);
    }
  ...
  describe("#getManagerFee", async () => {
    ...
    async function subject(): Promise<any> {
      return navIssuanceModule.getManagerFee(subjectCKToken, subjectFeeIndex);
    }
  ...
  describe("#getExpectedCKTokenIssueQuantity", async () => {
    ...
    async function subject(): Promise<any> {
      return navIssuanceModule.getExpectedCKTokenIssueQuantity(subjectCKToken, subjectReserveAsset, subjectReserveQuantity);
    }
  ...
  describe("#getExpectedReserveRedeemQuantity", async () => {
    ...
    cacheBeforeEach(async () => {
      ...
      await navIssuanceModule.initialize(ckToken.address, navIssuanceSettings);
    ...
    async function subject(): Promise<any> {
      return navIssuanceModule.getExpectedReserveRedeemQuantity(subjectCKToken, subjectReserveAsset, subjectCKTokenQuantity);
    }
  ...
  describe("#isIssueValid", async () => {
    ...
    async function subject(): Promise<any> {
      return navIssuanceModule.isIssueValid(subjectCKToken, subjectReserveAsset, subjectReserveQuantity);
    }
  ...
  describe("#isRedeemValid", async () => {
    ...
    async function subject(): Promise<any> {
      return navIssuanceModule.isRedeemValid(subjectCKToken, subjectReserveAsset, subjectCKTokenQuantity);
    }
    ...
    context("when there are 4 components and reserve asset is USDC", async () => {
      ...
      context("when there are no fees and no issuance hooks", async () => {
        ...
        it("should emit the CKTokenNAVIssued event", async () => {
          const expectedCKTokenIssued = await navIssuanceModule.getExpectedCKTokenIssueQuantity(
            subjectCKToken,
            subjectReserveAsset,
            subjectReserveQuantity
          );
          await expect(subject()).to.emit(navIssuanceModule, "CKTokenNAVIssued").withArgs(
            subjectCKToken,
    ...
    context("when there are 4 components and reserve asset is USDC", async () => {
      ...
      context("when there are no fees and no redemption hooks", async () => {
        ...
        it("should emit the CKTokenNAVRedeemed event", async () => {
          await expect(subject()).to.emit(navIssuanceModule, "CKTokenNAVRedeemed").withArgs(
            subjectCKToken,
            subjectCaller.address,
            subjectTo.address,
            subjectReserveAsset,
  ...
  context("Manager admin functions", async () => {
    ...
    describe("#addReserveAsset", async () => {
      ...
      async function subject(): Promise<any> {
        return navIssuanceModule.connect(subjectCaller.wallet).addReserveAsset(subjectCKToken, subjectReserveAsset);
      }

      it("should add the reserve asset", async () => {
        await subject();
        const isReserveAssetAdded = await navIssuanceModule.isReserveAsset(subjectCKToken, subjectReserveAsset);
        const reserveAssets = await navIssuanceModule.getReserveAssets(subjectCKToken);
    ...
    describe("#removeReserveAsset", async () => {
      ...
      async function subject(): Promise<any> {
        return navIssuanceModule.connect(subjectCaller.wallet).removeReserveAsset(subjectCKToken, subjectReserveAsset);
      }

      it("should remove the reserve asset", async () => {
        await subject();
        const isReserveAsset = await navIssuanceModule.isReserveAsset(subjectCKToken, subjectReserveAsset);
        const reserveAssets = await navIssuanceModule.getReserveAssets(subjectCKToken);
    ...
    describe("#editPremium", async () => {
      ...
      async function subject(): Promise<any> {
        return navIssuanceModule.connect(subjectCaller.wallet).editPremium(subjectCKToken, subjectPremium);
      }

      it("should edit the premium", async () => {
        await subject();
        const retrievedPremium = await navIssuanceModule.getIssuePremium(subjectCKToken, ADDRESS_ZERO, ZERO);
    ...
    describe("#editManagerFee", async () => {
      ...
      async function subject(): Promise<any> {
        return navIssuanceModule.connect(subjectCaller.wallet).editManagerFee(subjectCKToken, subjectManagerFee, subjectFeeIndex);
      }

      it("should edit the manager issue fee", async () => {
        await subject();
        const managerIssueFee = await navIssuanceModule.getManagerFee(subjectCKToken, subjectFeeIndex);
      ...
      describe("when editing the redeem fee", async () => {
        ...
        it("should edit the manager redeem fee", async () => {
          await subject();
          const managerRedeemFee = await navIssuanceModule.getManagerFee(subjectCKToken, subjectFeeIndex);
    ...
    describe("#editFeeRecipient", async () => {
      ...
      async function subject(): Promise<any> {
        return navIssuanceModule.connect(subjectCaller.wallet).editFeeRecipient(subjectCKToken, subjectFeeRecipient);
      }

      it("should edit the manager fee recipient", async () => {
        await subject();
        const navIssuanceSettings = await navIssuanceModule.navIssuanceSettings(subjectCKToken);
    ...
    function shouldRevertIfModuleDisabled(subject: any) {
      describe("when the module is disabled", async () => {
        beforeEach(async () => {
          await ckToken.removeModule(navIssuanceModule.address);
        });
