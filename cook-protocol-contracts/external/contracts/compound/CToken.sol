...
contract CToken is EIP20Interface, Exponential, TokenErrorReporter, ReentrancyGuard {
    ...
    /**
      * @notice CKs a new comptroller for the market
    ...
    /**
      * @notice accrues interest and cks a new reserve factor for the protocol using _setReserveFactorFresh
    ...
    /**
      * @notice CKs a new reserve factor for the protocol (*requires fresh interest accrual)
