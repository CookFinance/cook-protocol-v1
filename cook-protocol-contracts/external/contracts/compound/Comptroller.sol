...
contract Comptroller is ComptrollerV3Storage, ComptrollerInterface, ComptrollerErrorReporter, Exponential {
    ...
    /**
      * @notice CKs a new price oracle for the comptroller
    ...
    /**
      * @notice CKs the closeFactor used when liquidating borrows
    ...
    /**
      * @notice CKs the collateralFactor for a market
    ...
    /**
      * @notice CKs maxAssets which controls how many markets can be entered
    ...
    /**
      * @notice CKs liquidationIncentive
