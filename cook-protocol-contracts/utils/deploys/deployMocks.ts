...
import { CustomCKValuerMock__factory } from "../../typechain/factories/CustomCKValuerMock__factory";
...
export default class DeployMocks {
  ...
  public async deployCustomCKValuerMock(): Promise<CustomCKValuerMock> {
    return await new CustomCKValuerMock__factory(this._deployerSigner).deploy();
  }
